...
import com.taobao.oceanbase.vo.inner.ObSimpleFilter;
	    public class QueryTestCaseForWhere_04_XX extends BaseCase{
		...
		private long lOwnerId[]={1, 2, 3, 4, 5, 6, 7};
	    ...
	    private long lCollecTimePrecise[]={10001,20001,30001,40001,50001,10003,10002};
	   	...
	   	//rData是查询出来的行 nInsertNumber是准备数据中原表行的序号
...
//	    private void print_columns(int keyNum)
//	    print  sColumn[]
//	    {
...
//        }	
		...
		public void test_Query_04_01_ColumnValueEqualCreateTimeType()
		{
		   ...
		   // prepare QueryInfo
		    ...
		    Value val = new Value();
		    RKey rkey = new RKey(new CollectInfoKeyRule(2, (byte) '0',3));
		    ...
		    check_query_result(result.getResult().get(0), 2);
		}
		@Test
		public void test_query_04_02_where_ColumnValue_equal_dateTimeType()
		{
			...
			*/
		    ...
		    Value val = new Value();
		    val.setSecond(dtCollectTime[1].getTime());	//2001-12-01 12:00:00
		    ...
		    Assert.assertEquals(ResultCode.OB_SUCCESS, result.getCode());
		    Assert.assertEquals(1, result.getResult().size()); 
		    Assert.assertEquals(dtCollectTime[1].getTime(), result.getResult().get(0).get("collect_time"));
		}
		@Test
		public void test_query_04_03_where_ColumnValue_equal_PreciseTimeType()
		{
			...
			*/
		    ...
		    Value obj = new Value();
		    obj.setSecond(dtCollectTime[3].getTime());	//2001-12-01 12:00:00
		    ObSimpleCond obSimpleCond = new ObSimpleCond("collect_time", ObSimpleCond.ObLogicOperator.EQ, obj);
		    ObSimpleFilter filter = new ObSimpleFilter();
		    filter.addCondition(obSimpleCond);
		    queryInfo.setFilter(filter);
		    ...
		    Assert.assertEquals(ResultCode.OB_SUCCESS, result.getCode());
		    Assert.assertEquals(1, result.getResult().size());
		    Assert.assertEquals(dtCollectTime[3].getTime(), result.getResult().get(0).get("collect_time"));
		}
		@Test
		...
		public void test_query_04_09_where_ColumnValue_equal_PreciseDateTimeType() 
		{
		    ...
		    Assert.assertEquals("20001", result.getResult().get(0).get("collect_time_precise").toString());
		...
		public void test_query_04_10_where_ColumnValue_equal_ObPreciseDateTimeType() 
		{
		    ...
		    Value val = new Value();
		    val.setMicrosecond(lCollecTimePrecise[6]); 
		    ObSimpleCond obSimpleCond = new ObSimpleCond("collect_time_precise",ObSimpleCond.ObLogicOperator.EQ,val);
		    ObSimpleFilter filter = new ObSimpleFilter();
		    filter.addCondition(obSimpleCond);
		    queryInfo.setFilter(filter);
		    ...
		    Assert.assertEquals(ResultCode.OB_SUCCESS, result.getCode());
		    Assert.assertEquals(1, result.getResult().size());
		    Assert.assertEquals("10002", result.getResult().get(0).get("collect_time_precise").toString());
		}	
		@Test
		public void test_Query_04_11_where_ColumnValueEqualObPreciseDateTimeType() 
		{
			...
			*/
		    ...
		    Value val = new Value();
		    val.setMicrosecond(lCollecTimePrecise[2]);//查询的是第0个数据10001
		    ObSimpleCond obSimpleCond = new ObSimpleCond("collect_time_precise", ObSimpleCond.ObLogicOperator.EQ,val);
		    ObSimpleFilter filter = new ObSimpleFilter();
		    filter.addCondition(obSimpleCond);
		    queryInfo.setFilter(filter);
		    ...
		    Assert.assertEquals(ResultCode.OB_SUCCESS, result.getCode());
		    Assert.assertEquals(1, result.getResult().size());
		    Assert.assertEquals("30001", result.getResult().get(0).get("collect_time_precise").toString());
			}
		@Test
		public void test_Query_04_12_Where_ColumnValueNotEqualIntType() 
		{
		    ...
		    result = obClient.query(collectInfoTable.getTableName(), queryInfo);
		    Assert.assertEquals(ResultCode.OB_SUCCESS, result.getCode());
		    Assert.assertEquals(result.getResult().size(),6);//查询出匹配的行数
		    Assert.assertEquals(lOwnerId[0], result.getResult().get(0).get("owner_id"));
		    Assert.assertEquals(lOwnerId[1], result.getResult().get(1).get("owner_id"));
		    Assert.assertEquals(lOwnerId[2], result.getResult().get(2).get("owner_id"));
		    Assert.assertEquals(lOwnerId[4], result.getResult().get(3).get("owner_id"));
		    Assert.assertEquals(lOwnerId[5], result.getResult().get(4).get("owner_id"));
		    Assert.assertEquals(lOwnerId[6], result.getResult().get(5).get("owner_id"));
		    // verify data插入的数据和查询的数据是否一致
		...
		@Test	//long不可以和null比较大小，只能比较等于与不等于
		...
		public void test_query_04_17_where_ColumnValue_NotEqual_VcharType()
		{
		    ...
		    result = obClient.query(collectInfoTable.getTableName(), queryInfo);
		    Assert.assertEquals(ResultCode.OB_SUCCESS, result.getCode());
		    Assert.assertEquals(6, result.getResult().size());//结果有6条，把每条都打印出来
		    for( int i = 0; i < 6; i++)
		    {
		    	check_query_result(result.getResult().get(i), i+1);  	
		    }
		...
		public void test_query_04_20_where_Column_LessThan_ValueDateTimeType()  
		{
		    ...
		    Value val=new Value();
			val.setSecond(dtCollectTime[3].getTime());
		    ...
		    Assert.assertEquals(dtCollectTime[0].getTime(), result.getResult().get(0).get("collect_time"));
		    Assert.assertEquals(dtCollectTime[1].getTime(), result.getResult().get(1).get("collect_time"));
		    Assert.assertEquals(dtCollectTime[2].getTime(), result.getResult().get(2).get("collect_time"));
		}
		@Test
	    ...
	    */
	    ...
	    Assert.assertEquals(lOwnerId[0], result.getResult().get(0).get("owner_id"));
	    //查询出匹配的行数 ， 查出来的是Null，需要问开发NULL不能和int类型的数比较
	    }
	    @Test
		public void test_query_04_22_where_ColumnValue_LessThan_PreciseDateTimeType() 
		{
		    ...
		    Assert.assertEquals(ResultCode.OB_SUCCESS, result.getCode());
		    Assert.assertEquals(1, result.getResult().size());
		    Assert.assertEquals("10001", result.getResult()
		    		.get(0).get("collect_time_precise").toString());
		}
		@Test
		...
		@Test
		public void test_query_04_24_where_ColumnValue_LessEqual_PreciseDateTimeType() 
		{
			Result<List<RowData>> result;
		    QueryInfo queryInfo = new QueryInfo();
		    RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 1));
		    ...
		    check_query_result(result.getResult().get(0), 0);
		    check_query_result(result.getResult().get(1), 1);
		    check_query_result(result.getResult().get(2), 5);
		    check_query_result(result.getResult().get(3), 6);
		}
		@Test // 需要再次检查
		...
		public void test_query_04_32_where_ColumnValue_LessEqual_PreciseDateTimeType() 
		{
		    ...
		    Assert.assertEquals(4, result.getResult().size());
		    Assert.assertEquals(lCollecTimePrecise[0], result.getResult().get(0).get("collect_time_precise"));
		    Assert.assertEquals(lCollecTimePrecise[1], result.getResult().get(1).get("collect_time_precise"));
		    Assert.assertEquals(lCollecTimePrecise[5], result.getResult().get(2).get("collect_time_precise"));
		    Assert.assertEquals(lCollecTimePrecise[6], result.getResult().get(3).get("collect_time_precise"));
		 }   
	    @Test 
	    ...
	    @Test // string类型的可以比较小于，大于，不等于，等于
		...
		public void test_query_04_39_where_ColumnValue_LessThan_PreciseDateTimeType() 
		{
		   ...
		   val.setMicrosecond(lCollecTimePrecise[1]); 
		    ...
		    Assert.assertEquals(3, result.getResult().size());
		    Assert.assertEquals(lCollecTimePrecise[0], result.getResult().get(0).get("collect_time_precise"));
		    Assert.assertEquals(lCollecTimePrecise[5], result.getResult().get(1).get("collect_time_precise"));
		    Assert.assertEquals(lCollecTimePrecise[6], result.getResult().get(2).get("collect_time_precise"));
		 }   
	    @Test
		...
		public void test_query_04_47_where_LessEqual_ColumnValue_PreciseDateTimeType() 
		{
		    ...
		    addColumns(queryInfo);
		    Value val = new Value();
		    val.setMicrosecond(lCollecTimePrecise[5]); 
		    ObSimpleCond obSimpleCond = new ObSimpleCond("collect_time_precise",ObSimpleCond.ObLogicOperator.LE,val);
		    ObSimpleFilter filter = new ObSimpleFilter();
		    filter.addCondition(obSimpleCond);
		    queryInfo.setFilter(filter);
	   ...
	   // @Test
		...
		public void test_query_04_49_03_where_ColumnValue_LessThan_CreateTimeType() 
		{
			...
			*/
		    ...
		    Value val = new Value();
		    RKey rkey = new RKey(new CollectInfoKeyRule(1, (byte) '0', 1));
		    ...
		    ObSimpleCond obSimpleCond = new ObSimpleCond("gm_modified", ObSimpleCond.ObLogicOperator.LT, val);//gm_modified
			ObSimpleFilter filter = new ObSimpleFilter();
			filter.addCondition(obSimpleCond);
			queryInfo.setFilter(filter);
	  ...
	  //  @Test
		...
		public void test_query_04_70_where_LessEqual_ColumnValue_PreciseDateTimeType()
		{
			...
			*/
		    ...
		    Value val = new Value();
		    val.setMicrosecond(lCollecTimePrecise[1]); //2001-12-01 12:00:00
		    ObSimpleCond obSimpleCond = new ObSimpleCond("collect_time_precise", ObSimpleCond.ObLogicOperator.LE,val);
		    ObSimpleFilter filter = new ObSimpleFilter();
		    filter.addCondition(obSimpleCond);
		    queryInfo.setFilter(filter);
