...
public class QueryTestCaseForInfo extends BaseCase {
	...
	private void query_check_info_case78(Result<List<RowData>> result,
			RKey start_rowkey, RKey end_rowkey, boolean isInclusiveStart,
			boolean isInclusiveEnd) {
		CollectInfoKeyRule infoRowkeys = ((CollectInfoKeyRule) start_rowkey
				.getKeyRule());
		...
		for (int i = 0; i < length; i++) {
			...
			for (String infoColumn : collectInfoTable.getAllColumnNames()) {
				if (!infoColumn.equals(ColumnInfo[11])) {
					assertEquals(collectInfoTable.getColumnValue(infoColumn,
							infoRowkey),
							result.getResult().get(i).get(infoColumn));
				} else {
					assertEquals(null,
							result.getResult().get(i).get(ColumnInfo[11]));
				}
			}
		}
	}
	...
	public void test_query01Normal() {
		...
		query_check_JoinInfo(result, start_rowkey, end_rowkey,
	...
	public void test_query02NodataNormal() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(99999, (byte) '0',
				11));
		RKey end_rowkey = new RKey(
				new CollectInfoKeyRule(99999, (byte) '0', 20));
	...
	public void test_query03TableNameIsNull() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 11));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 20));
	...
	public void test_query04TableNameIsBlank() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 21));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 30));
	...
	public void test_query05QueryInfoIsNull() {
		Result<List<RowData>> result;
		try {
			result = obClient.query(collectInfoTable.getTableName(), null);
		} catch (RuntimeException e) {
			assertEquals("query info null", e.getMessage());//没有错误提示
		}
	}
	...
	// TODO start_rowkey length less than 17
	@Test
	public void test_query07SKLessThan17() {
		Result<List<RowData>> result1;
		Result<List<RowData>> result2;
		QueryInfo Info1 = new QueryInfo();
		QueryInfo Info2 = new QueryInfo();
		RKey start_rowkey1 = new RKey("0000000200000001", true);
		RKey start_rowkey2 = new RKey(new CollectInfoKeyRule(2, (byte) '0', 1));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 20));
		...
		addColumns(Info1);
		addColumns(Info2);
		result1 = obClient.query(collectInfoTable.getTableName(), Info1);
		result2 = obClient.query(collectInfoTable.getTableName(), Info2);

		Assert.assertEquals(result1.getResult().size(), result2.getResult()
				.size());

		query_check_JoinInfo(result1, start_rowkey1, end_rowkey,
				Info1.isInclusiveStart(), Info1.isInclusiveEnd());

		query_check_JoinInfo(result2, start_rowkey2, end_rowkey,
	...
	public void test_query09EKIsNull() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 20));
		Info.setStartKey(start_rowkey);
		Info.setInclusiveStart(true);
		Info.setInclusiveEnd(true);
		Info.setPageSize(20);
	...
	public void test_query11EKBlank() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 30));
	...
	public void test_query14SKBiggerEK() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 61));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 51));
	...
	public void test_query15SKEqualEK() {
		...
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 61));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 61));
		...
		try {
			...
			Assert.assertEquals("start rowkey have to be less than end rowkey",
					e.getMessage());
			//Assert.assertEquals("can not find valid mergeserver",
			//		e.getMessage());
		}
	}
...
//					e.getMessage());
	...
	public void test_query17PreClosedLastOpen() {
		...
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 61));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 70));
...
//			}
	...
	public void test_query18PreOpenLastOpen() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 71));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 80));
		prepareInfo(Info, start_rowkey, end_rowkey);
		Info.setInclusiveStart(false);// startrowkey is in open interval
		Info.setInclusiveEnd(false);// endkey is in open interval
		addColumns(Info);
...
//			}
	...
	public void test_query19NoColumns() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 81));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 90));
...
//		}
	...
	public void test_query20IncorrectColumns() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '0', 91));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 100));
		prepareInfo(Info, start_rowkey, end_rowkey);
...
//			}
	...
	public void test_query21ColumnNull() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 101));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 110));
		prepareInfo(Info, start_rowkey, end_rowkey);
	...
	public void test_query22Blank() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 111));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 120));
		prepareInfo(Info, start_rowkey, end_rowkey);
	...
	public void test_query23WrongAndNull() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 121));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 130));
		prepareInfo(Info, start_rowkey, end_rowkey);
	...
	public void test_query24NullAndBlank() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 131));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 140));
		prepareInfo(Info, start_rowkey, end_rowkey);
	...
	public void test_query25WrongAndBlank() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 141));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 150));
		prepareInfo(Info, start_rowkey, end_rowkey);
	...
	public void test_query26WrongAndNullAndBlank() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 151));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 160));
		prepareInfo(Info, start_rowkey, end_rowkey);
...
//		}
	...
	public void test_query27Reverse() {
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 161));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 170));

		prepareInfo(Info, start_rowkey, end_rowkey);
		addColumns(Info);

		Info.addOrderBy(ColumnInfo[5], false);
		queryResult = obClient.query(collectInfoTable.getTableName(), Info);

		long length = CollectInfoKeyRule.countNum(start_rowkey, end_rowkey,
				Info.isInclusiveStart(), Info.isInclusiveEnd());
		assertEquals(queryResult.getResult().size(), length);

		CollectInfoKeyRule rowkeys = (CollectInfoKeyRule) end_rowkey
				.getKeyRule();
		...
		for (index = 1; index < length; index++) {
			String second = ((RowData) queryResult.getResult().get(index))
					.get(ColumnInfo[5]);
...
@Test
	public void test_query28Positive() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 171));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 180));

		prepareInfo(Info, start_rowkey, end_rowkey);
		addColumns(Info);

		Info.addOrderBy(ColumnInfo[5], true);
		result = obClient.query(collectInfoTable.getTableName(), Info);
	...
	// reverse,second positive
		...
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 181));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 190));
		...
		Info.addOrderBy(ColumnInfo[7], false);
		...
		if (!sameFirst.isEmpty()) {
			String second = ((RowData) queryResult.getResult().get(0))
					.get(ColumnInfo[6]);
			...
			for (index = 0; index < length2; index++) {
				...
				if (second.compareToIgnoreCase(next) < 0) {
					second = next;
				} else if (second.compareToIgnoreCase(next) == 0) {
			...
			if (!sameSecond.isEmpty()) {
				String third = ((RowData) queryResult.getResult().get(0))
						.get(ColumnInfo[7]);
				int length3 = sameSecond.size();
				for (index = 0; index < length3; index++) {
					String next = ((RowData) queryResult.getResult().get(
							sameSecond.get(index))).get(ColumnInfo[7]);
					if (third.compareToIgnoreCase(next) >= 0) {
						third = next;
					} else {
						break;
					}
	...
	public void test_query30OneWrong() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '1', 191));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 200));
...
//			}
	...
	public void test_query31OneNull() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 201));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 210));
	...
	public void test_query32OneBlank() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 211));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 220));
	...
	public void test_query33OneToOneWrong() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 221));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 230));
...
//	}
	...
	public void test_query34OneNullOneCorrect() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 231));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 240));
	...
	public void test_query35OneBlankOneCorrect() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 241));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 250));
	...
	public void test_query36OneWrongTwoCorrect() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 251));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 260));

		prepareInfo(Info, start_rowkey, end_rowkey);
		addColumns(Info);

		Info.addOrderBy("wrong_column1", false);
		Info.addOrderBy(ColumnInfo[0], false);
		Info.addOrderBy(ColumnInfo[1], false);
...
//			}
	...
	public void test_query37OneNullTwoCorrect() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 261));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 270));
	...
	public void test_query38OneBlankTwoCorrect() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 271));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 280));
	...
	public void test_query39WrongNullCorrect() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 281));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 290));
	...
	public void test_query40NullBlankCorrect() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '2', 291));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 300));
	...
	public void test_query41XRepeatTwoColumn() {
		...
		CollectInfoKeyRule rowkeys = (CollectInfoKeyRule) start_rowkey
				.getKeyRule();

		assertEquals(result.getResult().size(), length);

		assertEquals(
				collectInfoTable.getColumnValue(ColumnInfo[0],
						rowkeys.currRkey()),
				result.getResult().get(0).get(ColumnInfo[0]));
		...
		for (int i = 1; i < length; i++) {
			assertEquals(
					collectInfoTable.getColumnValue(ColumnInfo[0],
							rowkeys.nextRkey()),
					result.getResult().get(i).get(ColumnInfo[0]));

			for (String infoColumn : collectInfoTable.getAllColumnNames()) {
				if (!(infoColumn == ColumnInfo[0])) {
	...
	public void test_query41WrongblankCorrect() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 301));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 310));
	...
	public void test_query63PageSizeZero() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 311));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 320));
	...
	public void test_query64PageSizeLessThanZero() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 321));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 330));
	...
	public void test_query65PageSizeEqualLimit() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 331));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 340));
	...
	// pageSize>limit,the result less than pageSize
	@Test
	public void test_query66PageSizeMoreThanLimit() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 341));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 350));
	...
	// pageSize>limit,result more than limit,only return limit
	//@Test
	public void test_query66PageSizeAndResultMoreThanLimit() {
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 341));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 370));
	...
	public void test_query67PageNumEqualZero() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 351));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 360));
	...
	public void test_query68PageNumLessThanZero() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 361));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 370));
	...
	public void test_query69NumMultiplySizeLessThanFindCount() {
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 371));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 495));
		...
		Info.setLimit(40);
		Info.setPageSize(10);
		Info.setPageNum(10);// 10*10>40

		queryResult = obClient.query(collectInfoTable.getTableName(), Info);

		CollectInfoKeyRule rowkeys = new CollectInfoKeyRule(2, (byte) '4', 461);

		assertEquals(queryResult.getResult().size(), Info.getPageSize());

		query_check_single(rowkeys.currRkey(), 0);
		for (int i = 1; i < Info.getPageSize(); i++) {
	...
	public void test_query69ProductMoreThanFindCount() {
		...
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 371));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 380));
	...
	public void test_query70LimitEqualZero() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 381));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 390));
	...
	public void test_query71LimitLessThanZero() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '3', 391));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 400));
	...
	public void test_query72LimitMoreThan2000() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 401));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 410));
	...
	public void test_query73OrderBy() {
		String table = collectInfoTable.getTableName();
		RKey rowkey1 = new RKey(new CollectInfoKeyRule(2, (byte) '4', 403));
		RKey rowkey2 = new RKey(new CollectInfoKeyRule(2, (byte) '4', 405));
		...
		// the second column has null value
		rowMutator1.addColumn(ColumnInfo[2], value, false);
		rowMutator2.addColumn(ColumnInfo[2], value, false);
	...
	public void test_query76LastColumnRepeat() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 411));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 420));
	...
	public void test_query77MidColumnRepeat() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 421));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 430));

		prepareInfo(Info, start_rowkey, end_rowkey);

		for (int i = 0; i < 11; i++)
			Info.addColumn(ColumnInfo[i]);
		Info.addColumn(ColumnInfo[10]);// the mid column is picur1
		for (int i = 11; i < ColumnInfo.length; i++)
			Info.addColumn(ColumnInfo[i]);
	...
	public void test_query78MidColumnRepeatViciLostForItem() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 431));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 440));
		...
		for (int i = 0; i < 11; i++)
			Info.addColumn(ColumnInfo[i]);
		Info.addColumn(ColumnInfo[10]);// the mid column is picur1
		for (int i = 12; i < ColumnInfo.length; i++)
			// the next column miss
			Info.addColumn(ColumnInfo[i]);

		result = obClient.query(collectInfoTable.getTableName(), Info);
		query_check_info_case78(result, start_rowkey, end_rowkey,
				Info.isInclusiveStart(), Info.isInclusiveEnd());
	}
	...
	public void test_query79ColumnsOutOFOrder() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 441));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 450));
		...
		Info.addColumn(ColumnInfo[0]);
		Info.addColumn(ColumnInfo[3]);
		for (int i = 10; i < ColumnInfo.length; i++)
			Info.addColumn(ColumnInfo[i]);
	...
	public void test_query80PageNumNoSet() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 451));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 460));
...
//		}
	...
	public void test_query81PageNumAndPageSizeNoSet() {
		Result<List<RowData>> result;
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 461));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 470));
	...
	public void test_query82PageNumAndPageSizeNoSet() {
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 471));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(2, (byte) '4', 480));
	...
	@Test
	public void test_query83usetwotablet() {
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(999, (byte) 'z', 6190));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(1000, (byte) '0', 10));
		...
		CollectInfoKeyRule rowkeys = (CollectInfoKeyRule) start_rowkey.getKeyRule();
		
		//assertEquals(queryResult.getResult().size(), Info.getLimit());

		log.debug("currRkey = " + rowkeys.currRkey().getRowkey());
		query_check_single(rowkeys.currRkey(), 0);
		for (int i = 1; i < Info.getLimit(); i++) {
			query_check_single(rowkeys.nextRkey(), i);
		}
	...
	@Test
	public void test_query84useonetablet() {
		QueryInfo Info = new QueryInfo();
		RKey start_rowkey = new RKey(new CollectInfoKeyRule(999, (byte) 'z', 6190));
		RKey end_rowkey = new RKey(new CollectInfoKeyRule(999, (byte) 'z', 6199));
...
//					e.getMessage());}
		CollectInfoKeyRule rowkeys = (CollectInfoKeyRule) start_rowkey.getKeyRule();
		log.debug("currRkey = " + rowkeys.currRkey().getRowkey());
		log.debug("Return sum = " + Info.getLimit());
		query_check_single(rowkeys.currRkey(), 0);
		for (int i = 1; i < Info.getLimit(); i++) {
			query_check_single(rowkeys.nextRkey(), i);
		}
