...
//add qianzm [set_operation] 20151222 :b
int ObMergeExcept::cast_cells_to_res_type(common::ObRow *&tmp_row)
{
  int ret = OB_SUCCESS;
  //add qianzm [set_operation] 20160115:b
...
//add e
//add qianzm [set_operation] 20160115:b
int ObMergeExcept::add_result_type_array(common::ObArray<common::ObObjType>& result_columns_type)
{
...
{
  int ret = OB_SUCCESS;
  CAST_TO_INHERITANCE(ObMergeExcept);//add qianzm [set_operation] 20160115
  reset();
