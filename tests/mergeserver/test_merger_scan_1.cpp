...
//char *filename = "schema_scan_test_1_a.txt"; // test ok
//char *filename = "schema_scan_test_1_b.txt";
//char *filename = "schema_scan_test_3_a.txt";
//char *filename = "schema_scan_test_1_b.txt";
//char *filename = "schema_scan_test_2_b.txt";
//char *filename = "schema_scan_test_2_a.txt";
//char *filename = "schema_scan_test_2_a.txt";
//char *filename = "schema_scan_test_3_a.txt";
//char *filename = "schema_scan_test_4_a.txt";
//char *filename = "schema_scan_test_5_a.txt";

// 2_a
/*
 * const static  char * scanner_section_names[] = {
  "schema_scanner_1_2",
  "schema_scanner_3_4",
  "schema_scanner_5_8"
};
...
{
  char * filename = "test_data/schema_scan_test_1.txt";
