#ifndef OLAP_SELECT_WHERE_COMP_ORDER_LIMIT_H_ 
#define OLAP_SELECT_WHERE_COMP_ORDER_LIMIT_H_
#include "base_case.h" 
#include <string>
class SelectWhereCompOrderLimit:public OlapBaseCase
{
public:
  SelectWhereCompOrderLimit()
  {
    char case_name[512];
    int64_t size = 0;
...
private:
  static SelectWhereCompOrderLimit static_case_;
};  
#endif /* OLAP_SELECT_WHERE_COMP_ORDER_LIMIT_H_ */
