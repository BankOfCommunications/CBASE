#ifndef OLAP_GET_NOT_EXIST_ROWS_H_ 
#define OLAP_GET_NOT_EXIST_ROWS_H_

#include "base_case.h" 
#include <string>
class GetNotExistRows:public OlapBaseCase
{
public:
  GetNotExistRows()
  {
...
private:
  static GetNotExistRows static_case_;
};

#endif /* OLAP_GET_NOT_EXIST_ROWS_H_ */
